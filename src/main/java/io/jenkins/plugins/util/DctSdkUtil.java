...
public class DctSdkUtil {
  ...
  public DctSdkUtil(Run<?, ?> run, TaskListener listener, String credId) {
    ...
    this.defaultClient.setVerifyingSsl(!DelphixGlobalConfiguration.get().getSslCheck());
  ...
  public ProvisionVDBResponse provisionVdbFromBookmark(
      ProvisionVDBFromBookmarkParameters provisionVDBFromBookmarkParameters) throws ApiException {
